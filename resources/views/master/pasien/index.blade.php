...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="ml-1 mb-4">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-title="Tambah Data" data-post-id="" data-action-url="pasien/formAdd" data-bs-target="#form-modal">
                        Tambah
                    </button>
                ...
                <div class="table-responsive">
                    <table id="tableMain" class="display">
                        <thead>
                            <tr>
                                <th style="width: 100px;text-align: center;">No. RM</th>
                                <th>Nama Pasien</th>
                                <th style="width: 100px;text-align: center;">Tanggal Lahir</th>
                                <th style="width: 100px;text-align: center;">No. Telp</th>
