...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="ml-1 mb-4">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-title="Tambah Data" data-post-id="" data-action-url="asuransi/formAdd" data-bs-target="#form-modal">
                        Tambah
                    </button>
                ...
                <div class="table-responsive">
                    <table id="tableMain" class="display">
                        <thead>
                            <tr>
                                <th style="width: 120px;">Kode Asuransi</th>
                                <th>Nama Asuransi</th>
...
<script src="{{ asset('/js/asuransi.js') }}"></script>
@endpush