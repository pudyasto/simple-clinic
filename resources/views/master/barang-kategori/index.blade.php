...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="ml-1 mb-4">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-title="Tambah Data" data-post-id="" data-action-url="barang-kategori/formAdd" data-bs-target="#form-modal">
                        Tambah
                    </button>
...
<script src="{{ asset('/js/barang-kategori.js') }}"></script>
@endpush