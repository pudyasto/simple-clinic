...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
            <form name="form_print" id="form_print" autocomplete="off" target="_blank" method="GET" action="{{url('pendapatan/printData')}}">
                <div class="row">
                    <div class="col-sm-5">
...
@push('script-default')
<script src="{{ asset('/js/rptpendapatan.js?v='.rand(1,999)) }}"></script>
@endpush